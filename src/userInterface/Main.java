...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		IFacade facade;
		if(args.length < 1) {
			System.out.println("Loading default initialization file from input folder (has to be in the same path as system.jar!");
			facade = initializeFromFile(new File("input" + File.separator + "init.tman"));
		} else {		
