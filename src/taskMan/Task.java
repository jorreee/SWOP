...
//	}
	...
	/**
	 * Plan this task on a given planned start time
	 * 
	 * @param startTime
	 *            | The timestamp to plan on
	 * @return True when the task has been planned on the specified timestamp
	 */
...
//		}
	...
	/**
	 * Reserve a resource for this task from a given start time to a given end time
	 * 
	 * @param resource
